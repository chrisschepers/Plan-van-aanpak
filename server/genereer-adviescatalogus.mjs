...
const TRIGGERS = {
  ...
  noRiskMogelijk: "De bedrijfsarts geeft aan dat mogelijk een no-riskpolis of vangnetregeling (Ziektewet) van toepassing is, of noemt de no-riskstatus expliciet.",
};
let nr = 0;
