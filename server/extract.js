...
const SCHEMA = {
  ...
  properties: {
    ...
    bronnen: {
      ...
      additionalProperties: false,
      properties: {
        naam: str, functie: str, contracturen: str, eersteZiektedag: str,
        belastbaarheid: str, opbouwtempo: str, startdatumOpbouw: str,
        werkaanpassing: str, prognose: str,
      },
      required: ["naam", "functie", "contracturen", "eersteZiektedag", "belastbaarheid", "opbouwtempo", "startdatumOpbouw", "werkaanpassing", "prognose"],
    },
  },
  required: [
    "naam", "functie", "contracturen", "eersteZiektedag", "geboortedatum",
    "einddatumDienstverband", "werkgever", "belastbaarheid", "opbouwtempo",
    "startdatumOpbouw", "werkaanpassing", "prognose", "evaluatie",
